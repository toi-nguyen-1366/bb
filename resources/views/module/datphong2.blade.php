  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-group" style="">
        ...
        <select class="form-control multiselect2 kenhnao" name="Biết qua kênh" required multiple="multiple">
    ...
    <div class="col-md-6">
      <div class="form-group" style="">
        ...
        <select class="form-control multiselect2 loainao" name="Thuê loại villa" required multiple="multiple">
          <option>Villa cư dân (Loại thông thường)</option>
          <option>Villa cư dân (Loại đặc biệt)</option>
          <option>Villa vận hành</option>
          <option>Loại khác, tôi cần tư vấn thêm</option>
        </select>
      </div>
    </div>
  </div>
  <div class="form-group m-b-15" style="">
    ...
    <div class="row">
      ...
      <div class="col-md-4 dv3">
        <p class="dv">
          <label class="dv2" {{-- data-toggle="tooltip" --}}  title="{!!strip_tags(str_replace(["\n","&nbsp;"], " ", $p['desc']))!!}">
