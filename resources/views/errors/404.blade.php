...
<body>
	<div id=notfound>
		<div class=notfound>
			...
			<h2>trang bạn đang tìm không có!</h2>
			<form class=notfound-search method=get action=/tim-kiem>
				<input type=text name=keyword placeholder="Nhập từ khóa...">
				<button type=submit>Tìm kiếm</button>
			</form>
			<a href=/><span class=arrow></span>Về trang chủ</a>
		</div>
	</div>
	</html>