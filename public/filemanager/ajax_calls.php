	...
	switch($_GET['action'])
	{
		...
		case 'save_img':
			...
			if($ftp){
				...
				create_img($temp,$temp,$config['thumb_width'],$config['thumb_height']);
				...
				create_img($current_path . $_POST['path'] . $_POST['name'], $thumbs_base_path.$_POST['path'].$_POST['name'], $config['thumb_width'], $config['thumb_height']);
